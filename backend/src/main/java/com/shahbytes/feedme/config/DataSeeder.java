...
public class DataSeeder {
    ...
    CommandLineRunner seedFeedMeData(UserProfileRepository userProfileRepository,
        ...
        return ignored -> {
            ...
            UserProfile ava = new UserProfile("u1", "ava", "Ava Chen", "Platform engineer", false);
            ...
            followRelationRepository.saveAll(
                    List.of(new FollowRelation(ava, marcus),
            ...
            postRepository.saveAll(
                    Stream.of(
                            ...
                            new Post(UUID.randomUUID().toString(), ava, "Yeah Sure, Keep dreaming!")
                    ).toList()
            );
        };
    }
