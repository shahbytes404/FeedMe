...
import com.shahbytes.feedme.dtos.TimelineMode;
...
public class FeedmeService {
    ...
    public FeedmeService(UserProfileRepository userProfileRepository, PostRepository postRepository, PostCreationRequestRepository postCreationRequestRepository, FollowRelationRepository followRelationRepository, FeedCacheService feedCacheService) {
